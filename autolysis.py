...
AIPROXY_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIxZjEwMDE4MDVAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.32KBPIbofnJzmCBzsD5_TpD0WmlBYr8TnzIIhC4djZY"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        ...
        print("No file path provided. Using a default test file.")
        file_path = "/content/goodreads.csv"  # Replace with your actual file path
    else:
